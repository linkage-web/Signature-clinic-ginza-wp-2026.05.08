<?php 
/**
 * Template Name: 施術内容 - 外用薬・ハイドロキノン
 */
?>
<?php get_header(); ?>
    ...
    <section id="treatment-description">
        <div class="container">
            <div class="treatment-thumb">
                <img src="<?php bloginfo('template_url'); ?>/assets/img/img_thumb_menu_treatment_hydroquinone.webp<?= strTimeStamp(); ?>" alt="外用薬・ハイドロキノン" loading="lazy">
            </div>
            <div class="title">
                <h2>外用薬・ハイドロキノン</h2>
            </div>
