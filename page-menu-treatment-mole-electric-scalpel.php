...
<main id="menu-treatment">
    ...
    <section id="treatment-description">
        <div class="container">
            <div class="treatment-thumb">
                <img src="<?php bloginfo('template_url'); ?>/assets/img/img_thumb_menu_trouble_skin.webp<?= strTimeStamp(); ?>" alt="ホクロ 電気メス" loading="lazy">
            </div>
            <div class="title">
                <h2>ホクロ 電気メスに関して</h2>
            </div>
            <div class="txt">
                <p>ホクロ 電気メス①ホクロ 電気メス①ホクロ 電気メス①ホクロ 電気メス①</p>
                <p>ホクロ 電気メス①ホクロ 電気メス①ホクロ 電気メス①ホクロ 電気メス①</p>
                <p>ホクロ 電気メス①ホクロ 電気メス①ホクロ 電気メス①ホクロ 電気メス①</p>
                <p>ホクロ 電気メス①ホクロ 電気メス①ホクロ 電気メス①ホクロ 電気メス①</p>
            </div>
    ...
    <section id="treatment-description2">
        <div class="container">
            <div class="r-area">
                ...
                <div class="context">
                    <p>ホクロ 電気メス②ホクロ 電気メス②ホクロ 電気メス②ホクロ 電気メス②ホクロ 電気メス②ホクロ 電気メス②ホクロ 電気メス②ホクロ 電気メス②ホクロ 電気メス②ホクロ 電気メス②ホクロ 電気メス②</p>
                    <p>ホクロ 電気メス②ホクロ 電気メス②ホクロ 電気メス②ホクロ 電気メス②ホクロ 電気メス②ホクロ 電気メス②ホクロ 電気メス②ホクロ 電気メス②ホクロ 電気メス②ホクロ 電気メス②ホクロ 電気メス②</p>
                </div>
            </div>
            <div class="l-area">
                ...
                <div class="context">
                    <p>ホクロ 電気メス③ホクロ 電気メス③ホクロ 電気メス③ホクロ 電気メス③ホクロ 電気メス③ホクロ 電気メス③ホクロ 電気メス③</p>
                    <p>ホクロ 電気メス③ホクロ 電気メス③ホクロ 電気メス③ホクロ 電気メス③ホクロ 電気メス③ホクロ 電気メス③ホクロ 電気メス③</p>
                </div>
            </div>
        </div>
    ...
    <section id="treatment-target" class="bg-p">
        <div class="container">
            ...
            <ul>
                <li><i class="fa-solid fa-square-check"></i><span>ホクロ 電気メス④ホクロ 電気メス④ホクロ 電気メス④ホクロ 電気メス④</span></li>
                <li><i class="fa-solid fa-square-check"></i><span>ホクロ 電気メス④ホクロ 電気メス④ホクロ 電気メス④ホクロ 電気メス④</span></li>
                <li><i class="fa-solid fa-square-check"></i><span>ホクロ 電気メス④ホクロ 電気メス④ホクロ 電気メス④ホクロ 電気メス④</span></li>
            </ul>
        </div>
    ...
    <section id="treatment-machine" class="bg-w">
        <div class="container">
            ...
            <a href="javascript:void(0)" class="machine-wrap">
                <p>エルマン</p>
            </a>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="contents">
                <div class="price-tbl pattern1">
                    <div class="p-ttl">ホクロ 電気メス⑥ホクロ 電気メス⑥</div>
                    <div class="p-row">
                        <div class="p-head">ホクロ 電気メス⑥</div>
