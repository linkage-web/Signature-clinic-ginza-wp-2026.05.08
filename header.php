          ...
          <ul>
            ...
            <li class="gnav-sub-menu-trigger<?= is_page('menu') ? ' is-current' : ''; ?>">
              ...
              <ul class="gnav-sub-menu">
                ...
                <li><a href="<?php bloginfo('url'); ?>/menu/idebae/">イデバエ(メソセラピー)</a></li>
                <li><a href="<?php bloginfo('url'); ?>/menu/whitein/">ホワイトイン(メソセラピー)</a></li>
                <li><a href="<?php bloginfo('url'); ?>/menu/redensity/">リデンシティ(メソセラピー)</a></li>
                <li><a href="<?php bloginfo('url'); ?>/menu/upgrade/">アップグレード(メソセラピー)</a></li>
