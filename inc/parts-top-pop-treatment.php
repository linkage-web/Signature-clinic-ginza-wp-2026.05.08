<div id="top-pop-treatment">
    <div id="pop-treatment-overlay" class="overlay"></div>
    <div class="wrapper">
        <div class="pop-ttl">「施術内容」から探す</div>
        <select name="select-treatment" id="select-treatment" onChange="location.href=value;">
            <option value="">施術内容を選択</option>
            <optgroup label="《肌・美容皮膚治療》">
                <option value="<?php bloginfo('url'); ?>/menu/luxcear/">光治療・IPLフォト『ルクセア』</option>
                <option value="<?php bloginfo('url'); ?>/menu/pico-laser">ピコレーザー『エンライトンSR』</option>
                ...
                <option value="<?php bloginfo('url'); ?>/menu/hifu/">ハイフ『ウルトラセル:Zi』</option>
                ...
                <option value="<?php bloginfo('url'); ?>/menu/bodymake/">ボディメイク・フェイシャルエステ『フォースカッター』</option>
                <option value="<?php bloginfo('url'); ?>/menu/yonirf/">フェム(膣)ケア『ヨニRF』</option>
            </optgroup>
            <optgroup label="《美容外科治療》">
                ...
                <option value="<?php bloginfo('url'); ?>/menu/thread-lift/">スレッド(糸)リフト</option>
            </optgroup>
            <optgroup label="《その他》">
        ...
        <div id="pop-treatment-close"></div>
    </div>
</div>