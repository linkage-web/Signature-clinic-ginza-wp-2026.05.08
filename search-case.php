...
$cat_trouble = $_GET['cat_trouble'];
$cat_treatment = $_GET['cat_treatment'];
$cat_machine = $_GET['cat_machine'];
?>
    ...
    <div class="search-cat-case-area">
      <section id="search-conditions">
        <div class="container">
          ...
          <div class="contents">
            <?php if (!empty($cat_trouble)): ?>
              <div class="conditions-troble">悩み：<?php echo get_term_by('slug', $cat_trouble, 'cat_trouble')->name; ?></div>
            <?php endif; ?>
            <?php if (!empty($cat_treatment)): ?>
              <div class="conditions-treatment">施術内容：<?php echo get_term_by('slug', $cat_treatment, 'cat_treatment')->name; ?></div>
            <?php endif; ?>
            <?php if (!empty($cat_machine)): ?>
              <div class="conditions-machine">機器：<?php echo get_term_by('slug', $cat_machine, 'cat_machine')->name; ?></div>
            <?php endif; ?>
          </div>
        </div>
      </section>
      <section id="search-cat-case-list">
        <?php if (empty($cat_trouble) && empty($cat_treatment) && empty($cat_machine)): ?>
          <div class="container">
            <p>カテゴリーを選択してください。</p>
          </div>
        <?php else: ?>
